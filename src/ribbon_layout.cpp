...
std::vector<int> RibbonLayout::commands(RibbonTab tab) {
    switch (tab) {
    case RibbonTab::File: return {100, 101, 102, 103, 104, 610, 611, 710, 711, 712, 713, 714, 800, 801, 802, 803, 804, 805, 806, 807, 808, 809};
    case RibbonTab::Drawing: return {200, 201, 202, 203, 204, 205};
    case RibbonTab::Modify: return {509, 500, 501, 502, 503, 504, 505, 506, 507, 508, 510, 511};
...
RibbonGeometry RibbonLayout::layout(RibbonTab tab, int windowWidth) {
    ...
    switch (tab) {
    case RibbonTab::File: groups = {{L"File", 5}, {L"Undo", 2}, {L"Export", 1}, {L"OpenSees", 4}, {L"Sonuçlar", 10}}; break;
    case RibbonTab::Drawing: groups = {{L"Draw", 5}, {L"Layers", 1}}; break;
    case RibbonTab::Modify:
        groups = {{L"Tools", 1}, {L"Modify", 5}, {L"Pattern", 2}, {L"Edit", 4}};
        break;
